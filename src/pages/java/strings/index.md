...
#### Comparing Strings 
If you want to compare the value of two String variables, you can't use ==. This is due to the fact that this will compare the references of the variables and not the values that are linked to them. To compare the stored values of the String you use the methode equals.
...
```
The first comparison is false because "==" looks at the references.

The seconde comparison is true because the variables store the same value. In this case "Hello world".
